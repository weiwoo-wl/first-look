...
type Work = { technical?: Technical; id: number; slug: string; title: string; description: string; type: string; status: string; story: string; creator_name: string; media: Media[] };
