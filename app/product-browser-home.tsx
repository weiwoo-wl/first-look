...
type Product = { slug: string; title: string; description: string; type: string; status: string; creator_name: string; creator_handle?: string; created_at: string; likes: number; favorites: number; shares: number; views: number; media: Media[]; coverUrl?: string; externalUrl?: string; sourceUrl?: string };
...
const independentProducts: Product[] = [
  { slug: "external-newt", title: "Newt", description: "一款融合阅读、写作、有声书与 AI 阅读助手的电子书应用。", type: "阅读应用", status: "外部作品", creator_name: "Product Hunt 独立作品", created_at: "", likes: 0, favorites: 0, shares: 0, views: 0, media: [], coverUrl: "https://ph-files.imgix.net/5819f578-abf8-4eab-95f5-e9ee4a8a1bf4.png?auto=format&fit=crop&frame=1&h=512&w=1024", externalUrl: "https://newt.ar", sourceUrl: "https://www.producthunt.com/products/newt" },
  { slug: "external-snaptodo", title: "SnapTodo", description: "把周计划、待办清单和 AI 整理结合起来的独立时间管理应用。", type: "效率工具", status: "外部作品", creator_name: "Product Hunt 独立作品", created_at: "", likes: 0, favorites: 0, shares: 0, views: 0, media: [], coverUrl: "https://ph-files.imgix.net/0cb3a71c-44e6-443a-ad2e-7064dd8ed399.png?auto=format&fit=crop&frame=1&h=512&w=1024", externalUrl: "https://snaptodo.app", sourceUrl: "https://www.producthunt.com/products/snaptodo" },
  { slug: "external-promptcraft", title: "PromptCraft", description: "把灵感和趋势转成适配 v0、Lovable 等工具的结构化提示词。", type: "创作工具", status: "外部作品", creator_name: "Product Hunt 独立作品", created_at: "", likes: 0, favorites: 0, shares: 0, views: 0, media: [], coverUrl: "https://ph-files.imgix.net/d9e71d1b-28db-4990-82c3-60ded73df354.png?auto=format&fit=crop&frame=1&h=512&w=1024", externalUrl: "https://promptcraft.live", sourceUrl: "https://www.producthunt.com/products/promptcraft-2" },
  { slug: "external-illustration-app", title: "illustration.app", description: "用文字生成可编辑、可缩放的 SVG 插画。", type: "设计工具", status: "外部作品", creator_name: "Product Hunt 独立作品", created_at: "", likes: 0, favorites: 0, shares: 0, views: 0, media: [], coverUrl: "https://ph-files.imgix.net/47ae3fbd-0966-40a3-9641-cf837765bf02.jpeg?auto=format&fit=crop&frame=1&h=512&w=1024", externalUrl: "https://www.illustration.app", sourceUrl: "https://www.producthunt.com/products/illustraai" },
  { slug: "external-launchforge", title: "LaunchForge", description: "帮独立创作者生成上线页、社交内容和发布素材。", type: "创作工具", status: "外部作品", creator_name: "Product Hunt 独立作品", created_at: "", likes: 0, favorites: 0, shares: 0, views: 0, media: [], coverUrl: "https://ph-files.imgix.net/7b634763-0ee7-4161-b375-027d54ddde2c.png?auto=format&fit=crop&frame=1&h=512&w=1024", externalUrl: "https://launch-forge-nine.vercel.app", sourceUrl: "https://www.producthunt.com/products/launch-kit-generator" },
  { slug: "external-stampcam", title: "StampCam", description: "把日常照片变成复古邮票，或一键抠图制作个性贴纸。", type: "摄影创作", status: "外部作品", creator_name: "Product Hunt 独立作品", created_at: "", likes: 0, favorites: 0, shares: 0, views: 0, media: [], coverUrl: "https://ph-files.imgix.net/761a6e9e-5630-4a7b-945d-e6f6b14a52b3.jpeg?auto=format&fit=crop&frame=1&h=512&w=1024", externalUrl: "https://stamp.cam", sourceUrl: "https://www.producthunt.com/products/stampcam" },
  { slug: "external-fujiseat", title: "Shinkansen Fuji Seat Finder", description: "去日本乘新干线时，快速确认订哪侧、哪个座位更容易看到富士山。", type: "旅行工具", status: "外部作品", creator_name: "Product Hunt 独立作品", created_at: "", likes: 0, favorites: 0, shares: 0, views: 0, media: [], coverUrl: "https://ph-files.imgix.net/5cc53a37-1ed0-470b-90d5-318dcca68ce5.png?auto=format&fit=crop&frame=1&h=512&w=1024", externalUrl: "https://fujiseat.com", sourceUrl: "https://www.producthunt.com/products/shinkansen-fuji-seat-finder" },
  { slug: "external-socrati", title: "Socrati", description: "把 PDF、视频或一个主题变成可听课程、练习题和记忆卡片。", type: "学习应用", status: "外部作品", creator_name: "Product Hunt 独立作品", created_at: "", likes: 0, favorites: 0, shares: 0, views: 0, media: [], coverUrl: "https://ph-files.imgix.net/7532cf56-4100-4d06-9cc1-3d4dcd1102c8.png?auto=format&fit=crop&frame=1&h=512&w=1024", externalUrl: "https://socrati.app", sourceUrl: "https://www.producthunt.com/products/socrati-learn-with-ai" },
  { slug: "external-dad-cant-draw", title: "Dad Can't Draw", description: "把孩子的点子变成可以打印、涂色的专属线稿。", type: "亲子创作", status: "外部作品", creator_name: "Product Hunt 独立作品", created_at: "", likes: 0, favorites: 0, shares: 0, views: 0, media: [], coverUrl: "https://ph-files.imgix.net/6c1e81d9-f811-4f6c-b9ab-eaa61369a9a9.png?auto=format&fit=crop&frame=1&h=512&w=1024", externalUrl: "https://dadcantdraw.com", sourceUrl: "https://www.producthunt.com/products/dad-can-t-draw" },
];
...
function ProductBrowser({ products }: { products: Product[] }) {
  ...
  return <div className="product-browser-shell" onKeyDown={(event) => { if (event.key === "ArrowLeft") select(Math.max(active - 1, 0)); if (event.key === "ArrowRight") select(Math.min(active + 1, products.length - 1)); }}>
    ...
    <div ref={trackRef} className="product-stack" onScroll={handleScroll} tabIndex={0} aria-label="产品展示">
      ...
      {Array.from({ length: slotCount }, (_, index) => { const product = products[index]; return product ? <div key={product.slug} className={`product-stack-item ${index === active ? "is-active" : ""}`} style={{ zIndex: index === active ? slotCount + 2 : index + 1 }} onMouseEnter={() => setActive(index)} onMouseLeave={() => setActive((current) => current === index ? -1 : current)}><a ref={(node) => { itemRefs.current[index] = node; }} href={product.externalUrl || `/work/${encodeURIComponent(product.slug)}`} target={product.externalUrl ? "_blank" : undefined} rel={product.externalUrl ? "noreferrer" : undefined} className="product-stack-link" onClick={(event) => { if (index !== active) { event.preventDefault(); select(index); } }} aria-current={index === active ? "true" : undefined}><ProductCover product={product} active={index === active} color={colors[index % colors.length]} /></a>{index === active && <div className="product-card-detail" aria-live="polite"><span>{product.externalUrl ? `海外独立作品 · ${product.type}` : product.type}</span><h3>{product.title}</h3><p>{product.description}</p>{product.externalUrl ? <div className="product-external-links"><a href={product.externalUrl} target="_blank" rel="noreferrer">访问产品 ↗</a><a href={product.sourceUrl} target="_blank" rel="noreferrer">Product Hunt 来源</a></div> : product.creator_handle ? <a href={`/creator/${encodeURIComponent(product.creator_handle)}`}><small>{product.creator_name}</small></a> : <small>{product.creator_name}</small>}</div>}</div> : <div key={`empty-${index}`} className="product-stack-item product-stack-empty-item" style={{ zIndex: index + 1 }}><EmptyProductSlot index={index} /></div>; })}
      <div className="product-stack-spacer" aria-hidden="true" />
    </div>
  </div>;
}
