...
type Product = { slug: string; title: string; description: string; type: string; status: string; creator_name: string; created_at: string; likes: number; favorites: number; shares: number; views: number; media: Media[] };
...
export default function ProductBrowserHome() {
  ...
  return <main className="min-h-dvh bg-[#f7f7f4] text-[#171717]">
    ...
    <section id="top" className="mx-auto max-w-7xl px-5 pb-10 pt-12 lg:px-8 lg:pt-16"><div className="max-w-3xl"><h1 className="text-4xl font-semibold leading-[1.08] tracking-[-0.065em] sm:text-5xl lg:text-[4rem]">每一个用 AI 创造的产品，<br /><span className="text-black/35">尤其是非专业创造者的产品，都有被发现的机会。</span></h1></div></section>
