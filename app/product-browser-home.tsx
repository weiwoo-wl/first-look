...
export default function ProductBrowserHome() {
  ...
  return <main className="min-h-dvh bg-[#f7f7f4] text-[#171717]">
    ...
    <footer className="border-t border-black/10 px-5 py-8 text-xs text-black/40"><div className="mx-auto flex max-w-7xl flex-wrap items-center justify-between gap-4"><span>© 2026 First Look</span><div className="flex items-center gap-5"><span>所有正在发生的创造</span><a href="mailto:server@firstlooklab.cn" className="text-black/60 transition hover:text-black">联系我们</a></div></div></footer>
  </main>;
}
