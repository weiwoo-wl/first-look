...
const independentProducts: Product[] = [
  ...
  { slug: "external-toolable", title: "Toolable.ai", description: "用自然语言创建、调整并分享自己的 AI 小工具。", type: "AI 工具", status: "外部作品", creator_name: "Product Hunt 独立作品", created_at: "", likes: 0, favorites: 0, shares: 0, views: 0, media: [], coverUrl: "https://ph-files.imgix.net/e2600f3b-b4d6-431c-a1cc-e7214dd3c06d.png?auto=format&fit=crop&frame=1&h=512&w=1024", externalUrl: "https://toolable.ai", sourceUrl: "https://www.producthunt.com/products/toolable-ai" },
